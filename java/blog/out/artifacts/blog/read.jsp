			...
			<div class="row">
				<div class="col-xs-5 text-right menu-1">
					<ul>
						...
						<li class="active"><a href="about.html">添加图书</a></li>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>KK'blog</h1>
							<h2>LJ'classdesign for javaweb <a href="http://" target="_blank"></a></h2>
						</div>
					</div>
				</div>
			</div>
...
<%--						</div>--%>
					...
					<div class="col-md-6 col-md-pull-6" id="image">
<%--						<img class="img-responsive" src="images/img_bg_1.jpg" alt="about">--%>
	...
	<script>
		...
		function show(texts) {
			var b=texts[0];
			$("#content").append("<h3>"+b.title+"</h3> <p>"+b.content+"</p>")
			$("#image").append("<img class=\"img-responsive\" src=\"/blog/upload/"+b.pics+"\">");
		}
